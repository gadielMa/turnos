...
function applyAdminLocale() {
  ...
  setLabel('clientName', 'Nome'); setLabel('clientDni', 'CPF'); setLabel('clientEmail', 'E-mail'); setLabel('clientWhatsapp', 'WhatsApp'); const clientCpf = document.getElementById('clientDni'); clientCpf.pattern = '[0-9]{11}'; clientCpf.maxLength = 11; clientCpf.minLength = 11;
  ...
  setText('#cashModal h2', 'Adicionar agendamento em dinheiro'); setLabel('cashName', 'Nome do cliente'); setLabel('cashDni', 'CPF'); const cashCpf = document.getElementById('cashDni'); cashCpf.pattern = '[0-9]{11}'; cashCpf.maxLength = 11; cashCpf.minLength = 11; setLabel('cashPaymentMethod', 'Status do pagamento'); document.querySelector('#cashPaymentMethod option[value="cash"]').textContent = 'Pagamento em dinheiro'; document.querySelector('#cashPaymentMethod option[value="pending"]').textContent = 'Pendente'; setLabel('cashService', 'Serviço'); setText('cashCancel', 'Cancelar'); document.querySelector('#cashForm button[type="submit"]').textContent = 'Salvar agendamento';
  setText('#clientEditModal h2', 'Editar cliente'); setLabel('editClientName', 'Nome'); setLabel('editClientDni', 'CPF'); setLabel('editClientEmail', 'E-mail'); setLabel('editClientWhatsapp', 'WhatsApp'); const editCpf = document.getElementById('editClientDni'); editCpf.pattern = '[0-9]{11}'; editCpf.maxLength = 11; editCpf.minLength = 11; setText('clientEditCancel', 'Cancelar'); document.querySelector('#clientEditForm button[type="submit"]').textContent = 'Salvar alterações';
